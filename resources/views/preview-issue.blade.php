...
<p><strong>Created:</strong> {{ \Carbon\Carbon::parse($report->created_at)->format('d-m-Y H:i:s') }}</p>
<p><strong>Updated:</strong> {{ \Carbon\Carbon::parse($report->updated_at)->format('d-m-Y H:i:s') }}</p>
